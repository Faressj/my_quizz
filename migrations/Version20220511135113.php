 ...
 */
final class Version20220511135113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD categorie_id INT DEFAULT NULL, ADD question VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE question ADD questions VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie DROP categorie_id, DROP question');
        $this->addSql('ALTER TABLE question DROP questions');
