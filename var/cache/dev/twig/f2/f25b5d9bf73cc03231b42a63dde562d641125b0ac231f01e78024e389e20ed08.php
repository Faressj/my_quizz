...
class __TwigTemplate_83b9bb426ff50c8bc813a96b8473f01096b386ef843913184e4b640322a514a3 extends Template
{
    private $source;
    private $macros = [];
...
<ul>
  ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["production"]) || array_key_exists("production", $context) ? $context["production"] : (function () { throw new RuntimeError('Variable "production" does not exist.', 22, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            // line 23
            echo "        <li>=><a href=\"/question/1/";
    ...
    {
        return array (  144 => 26,  128 => 11,  118 => 10,  99 => 6,  87 => 27,  85 => 26,  82 => 25,  71 => 23,  67 => 22,  61 => 18,  59 => 10,  52 => 6,  46 => 2,);
    }
...
<ul>
  {% for product in production %}
        <li>=><a href=\"/question/1/{{product.id}}\">{{product.name}}</a></li>
    {% endfor %}
</ul>
            {% block body %}{% endblock %}
        </div>
    </body>
</html>", "quizz/index.html.twig", "/home/tenimba/delivery/W-PHP-502-LYN-2-1-Quiz-tenimba.sangare/W-PHP-502-LYN-2-1-Quiz-tenimba.sangare/mon-super-projet/templates/quizz/index.html.twig");
    }
}
